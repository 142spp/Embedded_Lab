...
void TIM_Configure(void) {
  ...
  TIM_OCInitStructure.TIM_Pulse = 1500; // 1500us == 1.5ms
...
void moterrun(uint16_t pulse) {
    ...
    switch(pulse) {
    case 0:
          TIM_OCInitStructure.TIM_Pulse = 500; // us
          break;
    case 1:
          TIM_OCInitStructure.TIM_Pulse = 2400; // us
          break;
    }
